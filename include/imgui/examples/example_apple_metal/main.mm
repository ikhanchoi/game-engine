...
#if TARGET_OS_OSX
    CGFloat framebufferScale = view.windows.screen.backingScaleFactor ?: NSScreen.mainScreen.backingScaleFactor;
#else
...
- (void)viewWillAppear
{
    ...
    self.view.windows.delegate = self;
}
...
@property (nonatomic, strong) NSWindow *windows;
@end
...
-(instancetype)init
{
    if (self = [super init])
    {
        ...
        self.windows = [[NSWindow alloc] initWithContentRect:NSZeroRect
                                                  styleMask:NSWindowStyleMaskTitled | NSWindowStyleMaskClosable | NSWindowStyleMaskResizable | NSWindowStyleMaskMiniaturizable
                                                    backing:NSBackingStoreBuffered
                                                      defer:NO];
        self.windows.contentViewController = rootViewController;
        [self.windows center];
        [self.windows makeKeyAndOrderFront:self];
    }
    return self;
}
...
int main(int, const char**)
{
    @autoreleasepool
    {
        ...
        AppDelegate *appDelegate = [[AppDelegate alloc] init];   // creates windows
